...
const findTax=salary=>
{
    ...
    {
        return `The tax amount is ${10/100*salary}`;
    }
    else if(salary>1000000 && salary<=1500000)
    {
        return `The tax amount is ${20/100*salary}`;
    }
    else
    return `The tax amount is ${30/100*salary}`;
}

const salary=Number(prompt("Enter the salary of the person"));
